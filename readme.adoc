...
Than add a secret to your namespace that looks like the source file below.
Make you you fill in the username and the password.
...
[source,yaml]
---
include::./uptime-kuma/templates/secret.yaml
---
